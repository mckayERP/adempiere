...
/** Generated Model for PP_Order_BOMLineIssue
 *  @author Adempiere (generated) 
 *  @version Release 3.9.3 - $Id$ */
public class X_PP_Order_BOMLineIssue extends PO implements I_PP_Order_BOMLineIssue, I_Persistent 
{
    ...
    public X_PP_Order_BOMLineIssue (Properties ctx, int PP_Order_BOMLineIssue_ID, String trxName)
    {
      super (ctx, PP_Order_BOMLineIssue_ID, trxName);
      /** if (PP_Order_BOMLineIssue_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_PP_Order_BOMLineIssue (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_PP_Order_BOMLineIssue[")
