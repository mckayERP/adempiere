...
/** Generated Model for PP_OrderReceipt
 *  @author Adempiere (generated) 
 *  @version Release 3.9.3 - $Id$ */
public class X_PP_OrderReceipt extends PO implements I_PP_OrderReceipt, I_Persistent 
{
    ...
    public X_PP_OrderReceipt (Properties ctx, int PP_OrderReceipt_ID, String trxName)
    {
      super (ctx, PP_OrderReceipt_ID, trxName);
      /** if (PP_OrderReceipt_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_PP_OrderReceipt (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_PP_OrderReceipt[")
