...
// Y
	...
	/** Set Color Column.
		@param IsColorColumn 
		Is this field to be used to change the color of the displayed data in the row?
	  */
	...
	/** Get Color Column.
		@return Is this field to be used to change the color of the displayed data in the row?
	  */
	...
	/** Set Conditional Format.
		@param IsConditionalFormat 
		Select this checkbox to enable conditional formatting on this field.
	  */
	public void setIsConditionalFormat (boolean IsConditionalFormat)
	{
		set_Value (COLUMNNAME_IsConditionalFormat, Boolean.valueOf(IsConditionalFormat));
	}

	/** Get Conditional Format.
		@return Select this checkbox to enable conditional formatting on this field.
	  */
	public boolean isConditionalFormat () 
	{
		Object oo = get_Value(COLUMNNAME_IsConditionalFormat);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
