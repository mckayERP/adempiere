...
// E
	...
	/** Set Emergency Contact Relationship.
		@param EmergContactRelationship Emergency Contact Relationship	  */
	public void setEmergContactRelationship (String EmergContactRelationship)
	{
		set_Value (COLUMNNAME_EmergContactRelationship, EmergContactRelationship);
	}

	/** Get Emergency Contact Relationship.
		@return Emergency Contact Relationship	  */
	public String getEmergContactRelationship () 
	{
		return (String)get_Value(COLUMNNAME_EmergContactRelationship);
	}

	/** Set Emergency Contact Name.
		@param EmergencyContactName 
		The name of the person to contact if there is an emergency.
	  */
	public void setEmergencyContactName (String EmergencyContactName)
	{
		set_Value (COLUMNNAME_EmergencyContactName, EmergencyContactName);
	}

	/** Get Emergency Contact Name.
		@return The name of the person to contact if there is an emergency.
	  */
	public String getEmergencyContactName () 
	{
		return (String)get_Value(COLUMNNAME_EmergencyContactName);
	}
	...
	{
		set_Value (COLUMNNAME_EmergencyContactPhone, EmergencyContactPhone);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_EmergencyContactPhone);
	}
