...
public class ConfigVMOpenJDK extends Config
{
	...
	public String test()
	{
		...
		// There are no specific tests for this version of Java
		
		// Java home test is common - moved to ConfigurationData.setJavaHome()
...
//		System.setProperty(ConfigurationData.JAVA_HOME, javaHome.getAbsolutePath());
		...
		//	Java Version - tested in the ConfiguraitonData using Login.isJavaOK()
