...
public class ConfigVMSun extends Config
{
	...
	public void init()
	{
		// Moved to ConfigurationData.setJavaHome();
	...
	public String test()
	{
//		//	Java Home - tested in ConfigurationData.testJava()
...
//		if (!pass)
//			return error;
		//	Look for tools.jar to make sure that it is not the JRE - TODO - does this apply to version 8?
		File tools = new File (p_data.getJavaHome() 
			+ File.separator + "lib" + File.separator + "tools.jar");
		boolean pass = tools.exists();
...
//		p_data.setJavaHome(javaHome.getAbsolutePath());
...
//			return error;
		//
//		updateProperty(ConfigurationData.JAVA_TYPE, p_data.getJavaType());
