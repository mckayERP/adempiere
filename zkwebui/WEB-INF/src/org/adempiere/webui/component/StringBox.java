 ...
 *         <li>Implement embedded or horizontal tab panel
 *         https://adempiere.atlassian.net/browse/ADEMPIERE-319
 *         <li>New ADempiere 3.8.0 ZK Theme Light
 *         https://adempiere.atlassian.net/browse/ADEMPIERE-320
 */

public class StringBox extends Div
        implements org.zkoss.zul.api.Textbox, ITextField {
    ...
    private void init() {
        ...
        textbox = new Textbox();
        String style =
                AEnv.isFirefox2() ? "display: inline" : "display: inline-block";
